...
作者初次体验OPhone SDK，发现其基于Android并兼容其API，还集成了移动特色功能。虽有开发细节待完善，但作者看好其兼容性和在中国市场的广阔前景。
...
* Eclipse IDE
  * [Eclipse](http://www.eclipse.org/downloads/) 3.4.2 (Ganymede)
    * Eclipse [JDT](http://www.eclipse.org/jdt) 插件 (大部分的Eclipse IDE包已经包含JDT插件)
  ...
  * [JDK 5](http://java.sun.com/javase/downloads/index.jsp) or [JDK 6](http://java.sun.com/javase/downloads/index.jsp) (包括JRE)
