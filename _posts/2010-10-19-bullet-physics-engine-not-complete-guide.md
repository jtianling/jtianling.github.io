...
    Bullet作为一款开源物理引擎，你可以选择作者[编译好的SDK](<http://code.google.com/p/bullet/downloads/list> "编译好的SDK")  
，或者直接从源码编译自己的版本（Windows版本自带VS工程）。得益于CMake，在其他平台从源码自己编译也非常简单，[参考这里](<http://bulletphysics.org/mediawiki-1.5.8/index.php/Installation> "参考这里")  
。iPhone版本的话参考[这里](<http://www.jtianling.com/archive/2010/10/09/5928695.aspx> "这里")  
。想要更详细点的图文教程可以参考[Creating_a_project_from_scratch](<http://bulletphysics.org/mediawiki-1.5.8/index.php/Creating_a_project_from_scratch> "Creating_a_project_from_scratch")  
。
...
![](http://hi.csdn.net/attachment/201010/19/0_1287495180CII2.gif)  
...
![](http://hi.csdn.net/attachment/201010/19/0_1287495221z3jW.gif)  
...
1.[Ogre与Bullet的整合(on iPhone)](<http://www.jtianling.com/archive/2010/10/09/5928695.aspx> "Ogre与Bullet的整合\(on iPhone\)")  

2.[Ogre的3D Max插件介绍](<http://www.jtianling.com/archive/2010/10/09/5930269.aspx> "Ogre的3D Max插件介绍")
