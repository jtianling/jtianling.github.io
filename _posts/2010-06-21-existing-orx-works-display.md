...
    原论坛帖子[地址在此](<http://orx-project.org/forum?func=view&catid=13&id=494&limit=6> "地址在此")  
。[开源发布](<http://orx-project.org/ProjectX/MushroomStew-1.0a.zip> "开源发布")  
...
    [论坛原址](<http://orx-project.org/forum?func=view&catid=13&id=25> "论坛原址")  
，[开源发布](<http://orx-project.org/orx/drops.zip> "开源发布")  
。  
截图：
...
，这是 Blarg   
，一个iarwain说的原本是做Flash的设计师，原来根本不是程序员，在看了Orx的教程后，仅仅是通过模仿Orx教程中的一条一条特性，前后只用了一周多的时间（从帖子也可以看出来iarwain所说属实）开发出来的。。。。。。。。[闭源发布](<http://orx-project.org/users/blarg/DragonCube_v6.zip> "闭源发布")  
。  
