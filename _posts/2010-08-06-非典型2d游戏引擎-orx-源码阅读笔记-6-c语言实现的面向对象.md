...
orxSTRUCTURE_STORAGE_NODE结构对应，表示的是一个orxSTRUCTURE_STORAGE_NODE结构结构的list或者tree。因为根据Orx中list/tree的使用方法。(比较奇怪，[见以前的文章](<http://www.jtianling.com/archive/2010/08/04/5786973.aspx> "见以前的文章")  
）
