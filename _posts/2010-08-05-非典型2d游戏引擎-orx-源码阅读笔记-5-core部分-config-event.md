...
    有的引擎的源代码是越看越吸引人的，越看越让人惊呼设计之精巧，实现之完美的，很遗憾的，Orx的源码不是属于那一类，使用的感觉也不像那一类，反而越看越觉得其设计思想上与主流思想格格不入。。。。。在[上一节](<http://www.jtianling.com/archive/2010/08/04/5786973.aspx> "上一节")  
