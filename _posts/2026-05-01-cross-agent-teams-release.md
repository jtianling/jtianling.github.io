...
我自己在用的那个 zsh launcher 函数(连同前后注释和前置依赖说明) 我贴到了一个 gist, 直接 source 或贴进 `~/.zshrc` 都行: <https://gist.github.com/jtianling/6c2769f76ffb8fbff8856f90dc7f9554>. 完整文字步骤(MCP 配置怎么写, 前后顺序怎么排) 见仓库 README 的 ["Let other agents wake you (codex-appserver poke)"](https://github.com/jtianling/cross-agent-teams-mcp#let-other-agents-wake-you-codex-appserver-poke) 一节.
