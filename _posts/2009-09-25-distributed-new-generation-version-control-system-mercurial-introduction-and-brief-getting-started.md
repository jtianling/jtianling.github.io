...
介绍分布式版本控制工具Mercurial，说明其相较于集中式的优势，并提供从安装到克隆、提交、推送的简明入门教程。
