...
编程初学常感枯燥。本文推荐Small Basic的Turtle图形化编程，通过画图直观学习循环等核心概念，让编程入门变得有趣易懂。
...
以Turtle.Show()表示显示，Turtle.Move(100)表示移动，Turn，TurnLeft,TurnRight表示转向如此简单，但是却可以完成一些较为复杂的东西。
...
我接着看到了Introducing Small Basic中一个很漂亮的图形，于是提出解决此问题，竟然很容易从图形中看出思路，无非就是乌龟在原地没转一个方向就画一个圆嘛。
