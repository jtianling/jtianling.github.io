...
的[FX](<http://orx-project.org/wiki/en/orx/tutorials/fx>)  
。[胡四娃](<http://www.cppblog.com/Husiwa/>)  
译最新版本见[Orx  
官方Wiki中文教程](<http://orx-project.org/wiki/cn/orx/tutorials/fx>)  
。转载自：胡四娃的[博客](<http://www.cppblog.com/Husiwa/>)  
。原文链接在[http://www.cppblog.com/Husiwa/archive/2010/07/07/119534.aspx](<http://www.cppblog.com/Husiwa/archive/2010/07/06/119428.html>)  
。
...
[各向异性  
](<http://baike.baidu.com/view/26056.htm?fr=ala0_1_1>)  
的值（译者注：专业名  
[词anisotropic  
](<http://en.wikipedia.org/wiki/Anisotropic_value>)  
...
源代码:   
[07_FX.c  
](<https://orx.svn.sourceforge.net/svnroot/orx/trunk/tutorial/src/07_FX/07_FX.c>)  

配置文件:   
[07_FX.ini  
](<https://orx.svn.sourceforge.net/svnroot/orx/trunk/tutorial/bin/07_FX.ini>)